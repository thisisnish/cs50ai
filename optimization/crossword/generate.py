    ...
    def revise(self, x, y):
        ...
        for x_value in list(self.domains[x]):
            ...
            for y_value in self.domains[y]:
                if len(y_value) > j and x_value[i] == y_value[j]:
                    compatible = True
                    break
        ...
        for variable in assignment:
            ...
            for neighbor in self.crossword.neighbors(variable):
                if neighbor in assignment and assignment[neighbor] == assignment[variable]:
                    return False
                if neighbor in assignment and self.crossword.overlaps[variable, neighbor] != (assignment[variable][self.crossword.overlaps[variable, neighbor][0]], assignment[neighbor][self.crossword.overlaps[variable, neighbor][1]]):
                    return False
        return True
            ...
            for neighbor in self.crossword.neighbors(var):
                if neighbor not in assignment:
                    for neighbor_value in self.domains[neighbor]:
                        if self.crossword.overlaps[var, neighbor] == (value[self.crossword.overlaps[var, neighbor][0]], neighbor_value[self.crossword.overlaps[var, neighbor][1]]):
                            count += 1
            return count
