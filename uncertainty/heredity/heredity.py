...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    def parent_pass_probability(parent_genes):
        if parent_genes == 2:
    ...
    # people = {"name" : {"name", "mother", "father", "trait" }, ...}
    
    joint_prob = 1
    # calculate probability of each person having gene and trait
    for person in people.keys():
        ...
        trait_prob = PROBS["trait"][person_gene][person in have_trait]
        # unconditional probability of gene
        if not mother and not father:
            gene_prob = PROBS["gene"][person_gene]
        # conditional probability of gene
        else:
            mother_prob = parent_pass_probability(
                2 if mother in two_genes else 1 if mother in one_gene else 0
            )

            father_prob = parent_pass_probability(
